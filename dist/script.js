...
var filter = function filter() {
  ...
  var useTypeFilter = function useTypeFilter(selector) {
    if (selector === '.grandmother' || selector === '.granddad') {
      menu.querySelector(selector).addEventListener('click', function () {
        typeFilter();
      });
    } else {
      menu.querySelector(selector).addEventListener('click', function () {
...
var forms = function forms() {
  ...
  form.forEach(function (item) {
    item.addEventListener('submit', function (e) {
      ...
      item.classList.add('animated', 'rotateOutUpRight');
      setTimeout(function () {
      ...
      /* 		if (
      	...
      	item.classList.contains('.popup-design')
      ) {
      	api = path.designer;
      } else {
      	api = path.question;
      ...
      Object(_services_requests__WEBPACK_IMPORTED_MODULE_6__["postData"])(api, formData).then(function (res) {
        ...
        setTimeout(function () {
          ...
          item.classList.remove('rotateOutUpRight');
          item.classList.add('rotateInDownLeft');
        }, 5000);
      });
    });
  });
...
var modals = function modals() {
  ...
  bindModal('.fixed-gift', '.popup-gift', '.popup-gift .popup-close', true); //showModalByTime('.popup-consultation', 6000);
...
var showMoreStyles = function showMoreStyles(trigger, wrapper) {
  var btn = document.querySelector(trigger); //without db.json

  /* 	cards.forEach((card) => {
  	card.classList.add('animated', 'fadeInUpBig');
  });
  ...
  function createCards(response) {
    response.forEach(function (_ref) {
      ...
      card.classList.add('animated', 'fadeInUpBig', 'col-sm-3', 'col-sm-offset-0', 'col-xs-10', 'col-xs-offset-1');
    ...
    while (1) {
      switch (_context2.prev = _context2.next) {
        ...
        case 2:
          ...
          throw new Error("Could not fetch ".concat(url, ", stutus: ").concat(res.status));
